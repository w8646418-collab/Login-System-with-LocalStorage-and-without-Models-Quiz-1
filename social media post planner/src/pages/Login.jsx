...
const Login = () => {
  ...
  return (
    <section className="flex items-center justify-center min-h-screen bg-gradient-to-br from-yellow-100 via-purple-100 to-purple-300 relative overflow-hidden mt-18">
